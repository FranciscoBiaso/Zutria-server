...
class ConditionFireShiled: public ConditionGeneric
{
public:
	ConditionFireShiled(ConditionId_t _id, ConditionType_t _type, int32_t _ticks) : ConditionGeneric(_id, _type, _ticks) {};
	virtual ~ConditionFireShiled(){};

	virtual ConditionFireShiled* clone()  const { return new ConditionFireShiled(*this); }
};

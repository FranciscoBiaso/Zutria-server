...
enum CombatParam_t{
	...
	COMBATPARAM_MAGIC_INTERVALS         = 13,
	COMBATPARAM_COORDINATE_SYSTEM       = 14,
	COMBATPARAM_COEFFICIENT_A           = 15,
...
enum ConditionParam_t {
	...
	CONDITIONPARAM_INTERVAL_MAX                 = 15,
	...
	CONDITIONPARAM_PERIODICDAMAGE_TICKS         = 44,
	CONDITIONPARAM_TOTAL_DMG                   
};

enum BlockType_t {
	BLOCK_NONE = 0,
	BLOCK_DEFENSE_MIN = 2,
	BLOCK_DEFENSE_MEDIUM = 4,
	BLOCK_DEFENSE_MAX = 8,
	BLOCK_DODGE = 16,
	BLOCK_IMMUNITY = 32,
	BLOCK_SHIELD = 64,
	...
	BLOCK_PERFORATION_MIN = 2048,
	BLOCK_PERFORATION_MEDIUM = 4096,
	BLOCK_PERFORATION_MAX = 8192,
};
...
enum DamageType_t {
	...
	DAMAGE_PERFORATION_MIN = 16,
	DAMAGE_PERFORATION_MED = 32,
	DAMAGE_PERFORATION_MAX = 64,
	
	DAMAGE_SLASH_MIN = 128,
	DAMAGE_SLASH_MED = 256,
	DAMAGE_SLASH_MAX = 512,

};

enum AttackType_t {
	ATTACK_FAIL_NONE = 0,
	ATTACK_FAIL_ACCIDENTALLY  = 1,
	ATTACK_FAIL_CONCENTRATION = 2,
};
...
enum skills_t {
	SKILL_HEALTH_POINTS = 0,
	SKILL_PHYSICAL_ATTACK,
	SKILL_PHYSICAL_DEFFENSE,
	SKILL_CAPACITY,
	SKILL_MANA_POINTS,
	SKILL_MAGIC_ATTACK,
	SKILL_MAGIC_DEFENSE,

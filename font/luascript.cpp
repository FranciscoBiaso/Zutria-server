...
void LuaScriptInterface::registerFunctions()
{
	...
	lua_register(m_luaState, "doTransformItemAndKeepDuration", LuaScriptInterface::luaDoTransformItemAndKeepDuration);
...
int LuaScriptInterface::luaDoTransformItemAndKeepDuration(lua_State *L)
{
	//doTransformItem(uid, toitemid, <optional> count/subtype)
	int32_t parameters = lua_gettop(L);

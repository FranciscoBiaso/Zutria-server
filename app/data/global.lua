...
COMBAT_PARAM_MAGIC_INTERVALS = 13
COMBAT_PARAM_COORDINATE_SYSTEM = 14
COMBAT_PARAM_COEFFICIENTA = 15
COMBAT_PARAM_COEFFICIENTB = 16
COMBAT_PARAM_THETA = 17
COMBAT_PARAM_DRAW_FUNCTION = 18
COMBAT_PARAM_RANDOMGROWTH = 19
COMBAT_PARAM_ONLYDISTANCE = 20

--draw functions
DRAW_FUNCTION_ARQUIMEDES_SPIRAL = 0
DRAW_FUNCTION_FERMAT_SPIRAL     = 1
DRAW_FUNCTION_NONE              = 2

--system coordinate
POLAR_COORDINATE_SYSTEM = 1
CARTESIAN_COORDINATE_SYSTEM = 2
...
CONST_ME_POFF = 2
CONST_ME_FIREBALL = 3
CONST_ME_FIREBALL_EXPLOSION = 4
CONST_ME_FIREBALL_GREATEXPLOSION = 5
CONST_ME_FIREBALL_MASSIVERUNE = 17
CONST_ME_FIRESHIELD = 6
...
-- COMBAT DISTANCE EFFECTS -----------------------------////////////////////
CONST_ANI_FIREBALL = 0
CONST_ANI_FIREBALL_2 = 1
CONST_ANI_FIREBALL_3 = 2
CONST_ANI_SPEAR = 0
CONST_ANI_BOLT = 1
CONST_ANI_ARROW = 2
CONST_ANI_FIRE = 3

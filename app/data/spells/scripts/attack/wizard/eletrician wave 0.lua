...
setCombatParam(combat, COMBAT_PARAM_EFFECT, 20) -- effect of spell
...
setCombatParam(combat, COMBAT_PARAM_MAGIC_INTERVALS, 28)
--setCombatParam(combat, COMBAT_PARAM_ONLYDISTANCE, TRUE)
...
local area = createCombatArea(AREA_ENERGYWAVE, AREADIAGONAL_WAVE1)

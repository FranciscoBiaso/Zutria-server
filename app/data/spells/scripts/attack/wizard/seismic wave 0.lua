...
setCombatParam(combat, COMBAT_PARAM_EFFECT, 5) -- effect of spell
...
setCombatParam(combat, COMBAT_PARAM_MAGIC_INTERVALS, 22)
...
local area = createCombatArea(AREA_SEISMICWAVE, AREADIAGONAL_WAVE1)
